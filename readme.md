# 🚀 抖音每日点赞飙升榜 抖音自定义垂类视频点赞榜 抖音自定义关键词点赞榜 - 抖音关键词搜索、竞品分析、舆情监控工具 (Douyin Search & Analytics)
...
> **Note:** 请先通过微信 <13395823479> 申请TOKEN ，或访问[抖音达人数据获取官网](https://www.guaikei.com)开通TOKEN，配置环境变量 `GUAIKEI_API_TOKEN` 后才能正常运行。
...
- 或通过 [抖音KOL作品获取官网](https://www.guaikei.com) 自助开通TOKEN或查阅使用帮助。
