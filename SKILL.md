---
name: douyin-daily-surge
description: 抖音每日点赞飙升榜查询工具。实时获取全平台抖音作品，输出单日点赞TOP1000榜单，支持按赛道查询、按关键词查询、按发布时间筛选、按抖音视频时长筛选。当用户查询抖音飙升榜、抖音点赞飙升、抖音飙升排名、抖音飙升榜时使用。触发词：抖音飙升榜、抖音点赞飙升、飙升排名、飙升榜、抖音飙升、抖音新增视频榜单、抖音垂类行业点赞榜。支持四大能力：(1) 关键词搜索视频/图文，可按点赞数、发布时间、视频时长、内容类型筛选排序；(2) 实时热榜查询，获取抖音热搜词条与热度数据；(3) 博主作品抓取，按主页链接或 sec_uid 获取公开作品列表；(4) 视频评论分析，按视频链接或 aweme_id 获取评论内容与互动数据。
license: MIT
metadata:
  enabled: true
  type: command
...
抖音实时内容飙升监测工具，实时获取全平台抖音作品，输出新增点赞 TOP1000 榜单。根据关键词搜索抖音热门爆款作品，抖音最多点赞作品、抖音综合排序作品，获取抖音最新发布作品，支持按日期范围（一周、一天、半年）筛选，支持视频时长筛选，最大支持1次返回10000条搜索结果，返回点赞、评论、分享、收藏、发布时间、视频时长、视频标题、视频描述、视频链接、视频作者、视频标签、抖音小蓝词等数据。支持**关键词搜索排序**、**博主作品抓取**、**视频评论分析**、**实时热榜获取**。
